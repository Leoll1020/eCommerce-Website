...
$quantity = (!empty($_POST['qnt']) ? (int)$_POST['qnt'] : '');
...
foreach ($rows as $row){
    ...
    echo "works";
    echo $quantity;
    echo $row['tax_rate'] * $pPrice * $quantity + $pPrice * $quantity;
}
?>
...
<div style="width: 800px; margin: 50px auto 0 auto;">
  <form name="order_form"  method="POST">
    ...
    <p>Quantity of the product:</p><input type="text" id="qnt" name="qnt" required>
